...
\begin{tabular}{l c c } 
 \hline\noalign{\smallskip}
 \multicolumn{3}{c}{\textbf{Speed Up \tftree, \extree}} \\
\hline\noalign{\smallskip}
  & \tftree & \extree \\
 \noalign{\smallskip}
  & Aggr. & More Aggr. \\
 \hline\noalign{\smallskip}
 efficiency hash calls keygen & \multicolumn{2}{c}{$+25\%$} \\
 length efficiency & $- 29\%$ & $- 20\%$ \\
 efficiency hash calls verify & $+14\%$ & $+22\%$ \\ 
 \hline
\end{tabular}
\caption{Performance comparison of the \tftree and \extree, based on the Merkle Tree.} 
