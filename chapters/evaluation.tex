...
% lower bound merkle tree: hash calls tree gen. [18, 468, 11718, 292968, 7324218]
% upper bound merkle tree: hash calls tree gen. [93, 2343, 58593, 1464843, 36621093]
...
\begin{tabular}{r c l c l} 
 ...
 \noalign{\smallskip} 
 & lower / upper  & Tree Generation & Auth.path Length & Verify \\
 \noalign{\smallskip}
 & bound: $\ell$  & & aggr. / more aggr. & aggr. / more aggr.\\
 \hline\noalign{\smallskip}
