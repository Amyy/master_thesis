...
\begin{tabular}{c l c c} 
 ...
 $\ell$ & & aggr. / more aggr. & agg./ more aggr. \\
 \hline\noalign{\smallskip}
 $5^5$ & 2343 & 15 / 14 & 10 / 9 \\
...
\begin{tabular}{c l l l} 
 \hline\noalign{\smallskip}
 \multicolumn{4}{c}{\textbf{Evaluation Results NIST: Lower / Upper Bound Merkle Tree}} \\
 \noalign{\smallskip} 
  $\ell$ & Tree Generation & Auth.path Length & Verify \\
 % $\ell$ & & & \\
 \hline\noalign{\smallskip}
 $2^{11} $ & 2047 & in elements & verify \\
 $2^{12}$ & 4095 & in elements & verify \\
 \hline\noalign{\smallskip} 
 $2^{23}$ & 8388607 & authpath & Verify \\
 $2^{24}$ & 16777215 & authpath & verify \\
 \hline\noalign{\smallskip} 
 $2^{34}$ & 17179869183 & in elements & Verify \\ 
 $2^{35}$ & 34359738367 & in elements & Verify \\ 
 \hline\noalign{\smallskip} 
 $2^{46}$ & 70368744177663 & in elements & Verify \\ 
 $2^{47}$ & 140737488355327 & in elements & Verify \\
 \hline\noalign{\smallskip}  
 $2^{58}$ & 288230376151711743 & in elements & Verify \\ 
 $2^{59}$ & 576460752303423487 & in elements & Verify \\
 \hline\noalign{\smallskip}
 \end{tabular}
\caption{Evaluation results for \tftree and \extree given the NIST SHA-256 parameter sets as leaves $\ell$ (see Table~\ref{table:nist_param_each_tree}). The results contain the number of hash calls for tree generation and verify, as well as the length of the authentication path given the leaves $\ell$.}
