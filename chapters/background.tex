...
&= b_0 | \cdots | b_{t-1} \nonumber
\end{align}
The signature $\sigma$ is calculated by applying the one-way function $f$ to each element in the private key $X$ (see equation~\ref{eq:wots_privkey}) several times:  
