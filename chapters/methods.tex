...
\begin{tabular}{c l}
 ...
 \hline
\end{tabular}
\caption{The parameters of \extree. Notably, one \tfblock contains three Merkle layers, see Figure~\ref{img:t5_paper_block_depiction}.} % explain correlation T, d -> d = 3T really correct? maybe picture of T5Tree+?`
